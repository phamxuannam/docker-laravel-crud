...
<?php endif; ?>
            ...
            <table class="w-full">
                ...
                <tbody id="table-body" class="bg-white">
                    <?php echo $__env->make('permissions.permission-data', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </tbody>
...
<?php /**PATH /var/www/html/crud-api/resources/views/permissions/list.blade.php ENDPATH**/ ?>