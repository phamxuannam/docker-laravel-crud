                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('articles.store')); ?>" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="<?php echo e(old('title')); ?>" name="title" placeholder="Title" type="text"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="my-3">
                                <textarea name="text" placeholder="Content" class="border-gray-300 shadow-sm w-1/2 rounded-lg" id="text"
                                    cols="30" rows="10"><?php echo e(old('text')); ?></textarea>
                            </div>

                            <label for="" class="text-lg font-medium">Author</label>
                            <div class="my-3">
                                <input value="<?php echo e(old('author')); ?>" name="author" placeholder="Author" type="text"
                                    class="border-gray-300 shadow-sm w-1/2 rounded-lg">
...
<?php endif; ?>
<?php /**PATH /var/www/html/crud-api/resources/views/articles/create.blade.php ENDPATH**/ ?>