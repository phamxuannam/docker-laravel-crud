                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="<?php echo e(old('name', $user->name)); ?>" name="name" placeholder="Enter Name"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="my-3">
                                <input value="<?php echo e(old('age', $user->age)); ?>" name="age" placeholder="Enter Age"
                                    type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="my-3">
                                <input value="<?php echo e(old('email', $user->email)); ?>" name="email" placeholder="Enter Email"
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mt-3">
                                            ...
                                            <input <?php echo e($hasRoles->contains($role->id) ? 'checked' : ''); ?> type="checkbox"
                                                id="role-<?php echo e($role->id); ?>" class="rounded" name="role[]"
...
<?php endif; ?>
<?php /**PATH /var/www/html/crud-api/resources/views/users/edit.blade.php ENDPATH**/ ?>