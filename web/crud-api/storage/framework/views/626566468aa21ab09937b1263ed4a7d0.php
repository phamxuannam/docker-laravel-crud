...
<?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view articles')): ?>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button
                            ...
                            <div> <?php echo e(Auth::user()->name); ?> (<?php echo e(Auth::user()->roles->pluck('name')->implode(', ')); ?>)
                            </div>
...
<?php /**PATH /var/www/html/crud-api/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>