...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create articles')): ?>
...
<?php endif; ?>
                    ...
                    <?php if($articles->isNotEmpty()): ?>
                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="row-" class="border-b">
                                ...
                                <td class="px-6 py-3 text-left"> <?php echo e($article->text); ?> </td>
                                <td class="px-6 py-3 text-left"> <?php echo e($article->author); ?> </td>
                                <td class="px-6 py-3 text-left">
                                    
                                    <?php echo e(\Carbon\Carbon::parse($article->created_at)->format('d M, Y')); ?></td>
                                <td class="px-6 py-3 text-center">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete articles')): ?>
                                        ...
                                        <a href="javascript:void(0);" data-id="<?php echo e($article->id); ?>"
     ...
     <?php $__env->slot('script', null, []); ?> 
        ...
        <script>
            ...
            //     $.ajax({
            //         url: "<?php echo e(route('permissions.fetch')); ?>",
            //         method: 'GET',
            //         success: function() {
...
<?php /**PATH /var/www/html/crud-api/resources/views/articles/list.blade.php ENDPATH**/ ?>