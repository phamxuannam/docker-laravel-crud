     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create roles')): ?>
                <a href="<?php echo e(route('roles.create')); ?>" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Create</a>
            <?php endif; ?>
                ...
                <tbody class="bg-white">
                    <?php if($roles->isNotEmpty()): ?>
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="row<?php echo e($role->id); ?>" class="border-b">
                                <td class="px-6 py-3 text-left"> <?php echo e($role->id); ?> </td>
                                <td class="px-6 py-3 text-left"> <?php echo e($role->name); ?> </td>

                                
                                <td class="px-6 py-3 text-left"><?php echo e($role->permissions->pluck('name')->implode(', ')); ?>

                                </td>

                                <td class="px-6 py-3 text-left">
                                    
                                    <?php echo e(\Carbon\Carbon::parse($role->created_at)->format('d M, Y')); ?></td>
                                <td class="px-6 py-3 text-center">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete roles')): ?>
                                        ...
                                        <a href="javascript:void(0);" data-id="<?php echo e($role->id); ?>"
     ...
     <?php $__env->slot('script', null, []); ?> 
        ...
        <script>
            $(document).on('click', '.deleteBtn', function() {
                ...
                console.log(id);
                $.ajax({
                    url: "<?php echo e(route('roles.destroy', ':id')); ?>".replace(':id', id),
                    method: 'DELETE',
                    headers: {
...
<?php /**PATH /var/www/html/crud-api/resources/views/roles/list.blade.php ENDPATH**/ ?>