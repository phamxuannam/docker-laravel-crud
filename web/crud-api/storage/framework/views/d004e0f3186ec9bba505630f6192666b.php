     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create users')): ?>
                <a href="<?php echo e(route('users.create')); ?>" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Create</a>
            <?php endif; ?>
                ...
                <tbody class="bg-white">
                    <?php if($users->isNotEmpty()): ?>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="row<?php echo e($user->id); ?>" class="border-b">
                                ...
                                <td class="px-6 py-3 text-left"> <?php echo e($user->age); ?> </td>
                                <td class="px-6 py-3 text-left">
                                    
                                    <?php echo e(\Carbon\Carbon::parse($user->created_at)->format('d M, Y')); ?></td>
                                <td class="px-6 py-3 text-center">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete users')): ?>
                                        ...
                                        <a href="javascript:void(0);" data-id="<?php echo e($user->id); ?>"
...
<?php /**PATH /var/www/html/crud-api/resources/views/users/list.blade.php ENDPATH**/ ?>